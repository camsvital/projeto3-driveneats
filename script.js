...
function order() {
  let type1 = document.querySelector(".checked1 .food-type").textContent;
  ...
  let foods = document.querySelector(".checked1 .food-prices").textContent;
  ...
  let link = "https://wa.me/55021980802502?text=";
  ...
  textmessage = window.encodeURIComponent(textmessage);
  window.open(link + textmessage);
}
